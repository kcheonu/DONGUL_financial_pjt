# Generated by Django 4.2.7 on 2024-11-26 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saving', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financials.saving')),
            ],
        ),
        migrations.CreateModel(
            name='DepositOption',
            fields=[
                ...
                ('intr_rate', models.FloatField(null=True)),
                ('intr_rate2', models.FloatField(null=True)),
                ('deposit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financials.deposit')),
            ],
        ),
    ]
